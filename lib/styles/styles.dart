...
class Styles {
  ...
  ThemeData LIGHTTHEMEDATA(BuildContext context) => ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        foregroundColor: WidgetStatePropertyAll(
          Color(int.parse('0xff${settings?.button_font_color ?? 'ffffff'}')),
        ),
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      ...
      backgroundColor: Color(
        int.parse('0xff${settings?.button_color ?? 'ffffff'}'),
      ),
    ),
  ...
  static final MAINPAGECOMPONENTCARDCOLOR = Colors.white.withValues(alpha: 0.0);
  ...
  TextStyle TITLESTEXTSYTYLE(BuildContext context) => TextStyle(
    ...
    color: Color(int.parse('0xff${settings?.titles_font_color ?? 'ffffff'}')),
    shadows: [
      BoxShadow(
        offset: Offset(1, 1),
        blurRadius: 3,
        spreadRadius: 2,
        color: Color(
          int.parse('0xff${settings?.titles_font_shadow_color ?? 'ffffff'}'),
        ),
      ),
    ],
  );
  ...
  TextStyle SUBTITLESTEXTSYTYLE(BuildContext context) => TextStyle(
    ...
    shadows: [
      BoxShadow(
        ...
        spreadRadius: 2,
        color: Color(
          int.parse('0xff${settings?.subtitles_font_shadow_color ?? 'ffffff'}'),
        ),
      ),
    ],
  );
  ...
  TextStyle TEXTTEXTSYTYLE(BuildContext context) => TextStyle(
    ...
    shadows: [
      BoxShadow(
        ...
        spreadRadius: 2,
        color: Color(
          int.parse('0xff${settings?.text_font_shadow_color ?? 'ffffff'}'),
        ),
      ),
    ],
  );
